...
funcao: tipo_var nome_func T_PAR_ESQ argumentos T_PAR_DIR codigo
	;

argumentos: tipo_var nome_var
	| tipo_var nome_var T_VIRGULA argumentos
	|
	;

funcao_main: tipo_var T_MAIN T_PAR_ESQ T_PAR_DIR codigo
	;

codigo: T_CHA_ESQ multilinha T_CHA_DIR
	| linha
	;

multilinha: multilinha linha
	| linha
	;
...
condicional: if %prec THEN {printf("if\n");}
	| if else 
	;

if: T_IF T_PAR_ESQ condicao T_PAR_DIR T_DOIS_PONTOS codigo
	;
	
else: T_ELSE T_DOIS_PONTOS codigo
	;
...
do: T_DO codigo T_WHILE T_PAR_ESQ condicao T_PAR_DIR T_PONTO_VIRGULA
	;

while: T_WHILE T_PAR_ESQ condicao T_PAR_DIR T_DOIS_PONTOS codigo
	;

for: T_FOR T_PAR_ESQ nome_var T_DOIS_PONTOS valor T_VIRGULA valor T_VIRGULA valor T_PAR_DIR 
		T_DOIS_PONTOS codigo
	;
...
expressao: term T_PLUS expressao
	...
	| term
	| nome_var T_PLUS expressao
	| nome_var T_MINUS expressao
	| nome_var
